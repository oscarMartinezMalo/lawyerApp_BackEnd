...
/* harmony import */ var ClientApp_app_shared_components_dialog_custom_dialog_custom_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ClientApp/app/shared/components/dialog-custom/dialog-custom.component */ "./ClientApp/app/shared/components/dialog-custom/dialog-custom.component.ts");
/* harmony import */ var ClientApp_app_shared_errors_role_exist_error__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ClientApp/app/shared/errors/role-exist-error */ "./ClientApp/app/shared/errors/role-exist-error.ts");
...
class RoleAddDeleteUserComponent {
    ...
    ngOnInit() {
        ...
        this.editRoleForm.controls['userId'].valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(inputText => {
            return this.getUserListObservable(inputText || '');
        })).subscribe(userList => {
            if (userList.length > 0) {
                this.userArray = userList;
            }
            this.filteredOptions = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(userList);
        });
        this.fillFormEdit();
    }
    userSelected(user) {
    ...
    onDeleteUserFromRole($event, userToDelete) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const dialogData = new ClientApp_app_shared_components_dialog_custom_dialog_custom_component__WEBPACK_IMPORTED_MODULE_6__["DialogData"]('Confirm Action', `Are you sure you want to delete the user (${userToDelete.email}) from this role?`);
            const dialogRef = this.dialog.open(ClientApp_app_shared_components_dialog_custom_dialog_custom_component__WEBPACK_IMPORTED_MODULE_6__["DialogCustomComponent"], { maxWidth: '500px', data: dialogData });
    ...
    onSubmit() {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error instanceof ClientApp_app_shared_errors_role_exist_error__WEBPACK_IMPORTED_MODULE_7__["RoleExitsError"]) {
...
class UserAddDeleteRoleComponent {
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.roleForm.controls['roleId'].valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(inputText => {
                return this.getRoleListObservable(inputText || '');
            })).subscribe((roleList) => {
                if (roleList.length > 0) {
                    this.roleArray = roleList;
                }
                this.filteredOptions = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(roleList);
            });
        });
    }
    // AutoComplete Input
    ...
    onDelete($event, roleToDelete) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            $event.stopPropagation();
            const dialogData = new ClientApp_app_shared_components_dialog_custom_dialog_custom_component__WEBPACK_IMPORTED_MODULE_6__["DialogData"]('Confirm Action', `Are you sure you want to delete the role ${roleToDelete.name} from this User ${this.user.firstName} ${this.user.lastName} (${this.user.email})`);
            const dialogRef = this.dialog.open(ClientApp_app_shared_components_dialog_custom_dialog_custom_component__WEBPACK_IMPORTED_MODULE_6__["DialogCustomComponent"], { maxWidth: '500px', data: dialogData });
            dialogRef.afterClosed().subscribe((dialogResult) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                if (dialogResult) {
                    try {
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var ClientApp_app_shared_directives_requireMatch_Validator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ClientApp/app/shared/directives/requireMatch.Validator */ "./ClientApp/app/shared/directives/requireMatch.Validator.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/material/snack-bar */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/snack-bar.js");
...
class FirstDocumentFormComponent {
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.caseForm.controls['clientId'].valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(inputText => {
                return this.getClientListObservable(inputText || '');
            })).subscribe(clientList => {
                if (clientList.length > 0) {
                    this.clientArray = clientList;
                }
                this.filteredOptions = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(clientList);
            });
...
/* harmony import */ var ClientApp_environments_environment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ClientApp/environments/environment */ "./ClientApp/environments/environment.ts");
...
class AdminService {
    constructor(http, route, router, snackBar) {
        ...
        this.router = router;
        this.snackBar = snackBar;
        this.BASE_URL = `${ClientApp_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].baseUrl}api/account/`;
    }
    getRoleList() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var ClientApp_environments_environment__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ClientApp/environments/environment */ "./ClientApp/environments/environment.ts");
...
class AuthService {
    constructor(http, route, router, snackBar) {
        ...
        this.router = router;
        this.snackBar = snackBar;
        this.BASE_URL = `${ClientApp_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl}api/account/`;
    ...
    getUser() {
        return this.http.get(this.BASE_URL + 'getUser').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])((error) => {
    ...
    getUserById(userId) {
        return this.http.get(this.BASE_URL + 'getUserById/' + userId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])((error) => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(user => {
            return user;
        }));
    ...
    login(emailPassword) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.http.post(this.BASE_URL + 'signin', emailPassword).
                pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((token) => {
    ...
    changePassword(changePassword) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.http.post(this.BASE_URL + 'changePassword', changePassword).
                pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((resp) => {
                this.logOut();
                return resp;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])((error) => {
                if (error.status === 400) {
    ...
    refreshToken() {
        ...
        return this.http.post(this.BASE_URL + 'refresh-token', { refreshToken }).
            pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((token) => {
            localStorage.setItem(this.JWT_TOKEN, token.accessToken);
        }));
    }
    get getStoredToken() {
...
class CasesService {
    constructor(http, route, router, snackBar) {
        ...
        this.router = router;
        this.snackBar = snackBar;
        this.BASE_URL = `${ClientApp_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl}api/cases/`;
    }
    getCaseListOfLawyer() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
class ClientsService {
    constructor(http, route, router, snackBar) {
        ...
        this.router = router;
        this.snackBar = snackBar;
        this.BASE_URL = `${ClientApp_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].baseUrl}api/clients/`;
        this.opts = [];
    }
...
class DocumentService {
    constructor(http, route, router, snackBar) {
        ...
        this.router = router;
        this.snackBar = snackBar;
        this.BASE_URL = `${ClientApp_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl}api/documents/`;
    }
    downloadDocument() {
...
module.exports = __webpack_require__(/*! C:\Users\hp\Desktop\MVCprojects\LawyerApplication\lawyerApp_Backend\ClientApp\main.ts */"./ClientApp/main.ts");
