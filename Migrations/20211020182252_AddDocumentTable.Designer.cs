...
namespace LawyerApp.Migrations
{
    ...
    [Migration("20211020182252_AddDocumentTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LawyerApp.Data.Entities.Case", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LawyerApp.Data.Entities.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("NameInDirectory")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LawyerApp.Data.Entities.Case", b =>
                {
                    b.HasOne("LawyerApp.Data.Entities.Client", "Client")
                        .WithMany("Cases")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LawyerApp.Data.Entities.LawyerUser", null)
                        .WithMany()
